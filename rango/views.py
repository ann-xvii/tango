...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # Establish a link between the two model instances that we've created.
            # This is where we populate the user attribute of the UserProfileForm
            profile.user = user
    ...
    # Not an HTTP POST, so we render our form using two ModelForm instance.
...
def restricted(request):
    return HttpResponse("Since you're logged in, you can see this text! <br/><a href='/rango/'>Home</a>")
